  ...
  <div class="mt-4 px-2 ">
    ...
    <nav class="border-t border-gray-300 px-4 flex items-center justify-between sm:px-0">
      <div class="-mt-px w-0 flex-1 flex">
        <inertia-link v-if="paginate.prev_page_url" :href="`${paginate.prev_page_url}${getFilters}`" class="border-t-2 border-transparent pt-4 pr-1 inline-flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300">
      ...
      <div class="-mt-px w-0 flex-1 flex justify-end">
        <inertia-link v-if="paginate.next_page_url" :href="`${paginate.next_page_url}${getFilters}`" class="border-t-2 border-transparent pt-4 pl-1 inline-flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300">
          Próximo
